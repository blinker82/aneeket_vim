...
"
"CpusCommonElementsCpusCommonElements How_to_Install_on_Unix:
"    $ mkdir ~/.vim_runtime
...
vnoremap <C-J> <esc>:vertical resize +<CR>
vnoremap <C-K> <esc>:vertical resize -<CR>
...
" Format the statusline DO NOT ENABLE .. CAUSES TOO MANY REDRAWS .. SLOWS VIMS
...
" => FuzzyFinder plugin
""""""""""""""""""""""""""""""
map <leader>o  :FufTaggedFile<cr>
map <leader>r  :FufTag<cr>
map <leader>b  :FufBuffer<cr>
map <leader>bm :FufAddBookmark<cr>
map <leader>bg :FufBookmark<cr>


""""""""""""""""""""""""""""""
" => Exuberant Tags plugin
""""""""""""""""""""""""""""""
...
" for Ctrl-C for Copying to System ClipBoard and Insert for Paste
